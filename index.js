...
function robotRandom() {
  ...
  if (randomNum == 1) {
    //rock
    document.getElementById('robotID').src = '/image/rockP.png';
  } else if (randomNum == 2) {
    //paper
    document.getElementById('robotID').src = '/image/paperNew.png';
  } else {
    //scissor
    document.getElementById('robotID').src = '/image/ScissorNew.png';
  }
  return randomNum;
}
